...
void emxFreeStruct_struct0_T(struct0_T *pStruct) {
  emxFree_real_T(&pStruct->b_class);
  emxFree_real_T(&pStruct->weight);
  emxFree_real_T(&pStruct->area);
}
...
void emxInitStruct_struct0_T(struct0_T *pStruct) {
  emxInit_real_T1(&pStruct->b_class, 1);
  emxInit_real_T1(&pStruct->weight, 1);
  emxInit_real_T1(&pStruct->area, 1);
}
