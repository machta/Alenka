...
{
	DataModel* dataModel = testPrimary<GDF2>(TEST_DATA_PATH + "gdf/gdf00.gdf", "gdf");
...
{
	DataModel* dataModel = testPrimary<GDF2>(TEST_DATA_PATH + "gdf/gdf01.gdf", "gdf");
...
{
	DataModel* dataModel = testPrimary<EDF>(TEST_DATA_PATH + "edf/edf00.edf", "edf");
