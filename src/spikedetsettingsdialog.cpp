	...
	: QDialog(parent), settings(settings), eventDuration(eventDuration), originalSpikedet(originalSpikedet)
{
	...
	connect(k1_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_k1 = val; });
	...
	connect(k2_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_k2 = val; });
	...
	connect(k3_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_k3 = val; });
	...
	//n_box->setMaximum();
	connect(n_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_noverlap = val; });
	...
	//dt_box->setMaximum();
	connect(dt_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_discharge_tol = val; });
	...
	//ps_box->setMaximum();
	connect(pt_box, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), [settings] (double val) { settings->m_polyspike_union_time = val; });
