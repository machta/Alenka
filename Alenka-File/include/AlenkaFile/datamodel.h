...
public:
  ...
  virtual const AbstractEventTable *eventTable(int i) const override {
    return eTable[i];
  }
  virtual AbstractTrackTable *trackTable(int i) override { return tTable[i]; }
  virtual const AbstractTrackTable *trackTable(int i) const override {
    return tTable[i];
  }

protected:
  virtual AbstractEventTable *makeEventTable() override {
    return new EventTable();
  }
  virtual AbstractTrackTable *makeTrackTable() override {
