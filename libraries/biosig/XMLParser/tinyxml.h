...
#define TIXML_SAFE
		...
		#define TIXML_SNPRINTF _snprintf        /* Flawfinder: ignore *** Buffer size checked in each case */
		#define TIXML_SSCANF   sscanf           /* Flawfinder: ignore *** Only %d and %lf are used */
	#elif defined(__GNUC__) && (__GNUC__ >= 3 )
		// GCC version 3 and higher.s
		//#warning( "Using sn* functions." )
		#define TIXML_SNPRINTF snprintf         /* Flawfinder: ignore *** Buffer size checked in each case */
		#define TIXML_SSCANF   sscanf           /* Flawfinder: ignore *** Only %d and %lf are used */
	#else
		#define TIXML_SNPRINTF snprintf         /* Flawfinder: ignore *** Buffer size checked in each case */
		#define TIXML_SSCANF   sscanf           /* Flawfinder: ignore *** Only %d and %lf are used  */
