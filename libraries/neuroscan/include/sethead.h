//**************************************************************************************
//
// This is the Neuroscan sethead.h with the definitions of some binary file headers
// originating from a cnttoasc.zip file in the Neuroscan "Scan4" software.
// 
// modified:
//    11 feb 1999 - Robert Oostenveld (fixed 16/32 bit compatibility in TEEG_TYPE)
//
//**************************************************************************************
...
//************************************************************************
// The original Neuroscan code is not fully portable to 32 bits compilers 
//
// To fix this: if FIX_TEEG_TYPE is defined, replace TEEG_TYPE by 16/32 
// bits equivalent
//
// 11 feb 1999, Robert Oostenveld, University Nijmegen
//
//************************************************************************
 
#ifdef FIX_TEEG_TYPE
  typedef short TEEG_TYPE;
#else
  typedef enum
  {
...
//
// This structure describes an event type 0 in a continous file
typedef struct{
